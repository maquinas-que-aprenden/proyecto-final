...
* Los smoke tests (42 tests, 3 suites: clasificador, RAG generate, orquestador) se ejecutan con `pytest tests/ -v`. Los servicios externos (Bedrock, Ollama) están mockeados, por lo que no requieren credenciales en CI.
