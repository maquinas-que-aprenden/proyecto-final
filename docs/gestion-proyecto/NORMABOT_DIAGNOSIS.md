...
**Ubicación:** `src/orchestrator/main.py` (496 líneas)
...
**Ubicación:** `src/checklist/main.py` (470 líneas)
...
**Ubicación:** `src/memory/hooks.py` (42 líneas)
...
**Ubicación:** `src/rag/main.py` (273 líneas)
...
**Ubicación:** `src/classifier/main.py` (535 líneas)
...
**Ubicación:** `src/retrieval/retriever.py` (250+ líneas)
...
**Ubicación:** `src/observability/main.py` (34 líneas)
...
✓ src/classifier/main.py — predict_risk() con SHAP explicable + Anexo III override
